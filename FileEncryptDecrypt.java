...
public class Main {
    ...
    private static void encryptFile(String inputFilePath, String outputFilePath, int key)
            throws IOException {
        try
                (
    ...
    private static void decryptFile(String inputFilePath, String outputFilePath, int key)
        throws IOException
    {
        try
                (
